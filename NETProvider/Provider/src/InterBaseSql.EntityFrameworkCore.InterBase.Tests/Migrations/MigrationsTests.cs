...
#pragma warning disable EF1001
    ...
    FOREIGN KEY (""EmployerId"") REFERENCES ""Companies"" (""Id"") ON UPDATE NO ACTION ON DELETE NO ACTION
			...
			Assert.AreEqual(expectedCreateTable, batch[0].CommandText.Trim());
			StringAssert.Contains("create generator ", batch[1].CommandText);
		...
		public void AlterColumnType()
		{
			...
			var batch = Generate(new[] { operation });
			Assert.AreEqual(2, batch.Count());
			Assert.AreEqual(NewLineEnd(@"ALTER TABLE ""People"" ALTER COLUMN ""Col"" TYPE NUMERIC(18, 0) NOT NULL;"), batch[1].CommandText);
		}
		...
		public void AlterColumnAddSequenceTrigger()
		{
			...
			Assert.AreEqual(4, batch.Count());
			Assert.AreEqual(NewLineEnd(@"ALTER TABLE ""People"" ALTER COLUMN ""Col"" TYPE INTEGER NOT NULL;"), batch[1].CommandText);
			StringAssert.Contains("create generator ", batch[2].CommandText);
		...
		public void CreateSequence()
		{
			...
			var batch = Generate(new[] { operation });
			Assert.AreEqual(1, batch.Count());
			Assert.AreEqual(NewLineEnd(@"create generator ""MySequence"" START WITH 34 INCREMENT BY 56;"), batch[0].CommandText);
		}
		...
		public void AlterSequence()
		{
			...
			var batch = Generate(new[] { operation });
			Assert.AreEqual(1, batch.Count());
			Assert.AreEqual(NewLineEnd(@"alter generator ""MySequence"" RESTART INCREMENT BY 12;"), batch[0].CommandText);
		}
		...
		public void RestartSequence()
		{
			...
			var batch = Generate(new[] { operation });
			Assert.AreEqual(1, batch.Count());
			Assert.AreEqual(NewLineEnd(@"alter generator ""MySequence"" START WITH 23;"), batch[0].CommandText);
		}
