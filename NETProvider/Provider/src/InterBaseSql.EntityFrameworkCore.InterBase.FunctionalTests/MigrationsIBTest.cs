...
public class MigrationsIBTest : MigrationsTestBase<MigrationsIBTest.MigrationsIBFixture>
{
	const string SkipReason = "Assumptions in model differ too much between base tests and InterBase.";
