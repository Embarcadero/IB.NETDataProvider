...
public class TPTRelationshipsQueryIBTest : TPTRelationshipsQueryTestBase<TPTRelationshipsQueryIBTest.TPTRelationshipsQueryIBFixture>
{
	public TPTRelationshipsQueryIBTest(TPTRelationshipsQueryIBFixture fixture)
		: base(fixture)
	{ }

	public class TPTRelationshipsQueryIBFixture : TPTRelationshipsQueryRelationalFixture
	{
