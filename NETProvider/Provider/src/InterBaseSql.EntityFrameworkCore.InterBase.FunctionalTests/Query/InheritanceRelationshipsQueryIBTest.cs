...
public class InheritanceRelationshipsQueryIBTest : InheritanceRelationshipsQueryTestBase<InheritanceRelationshipsQueryIBFixture>
{
	public InheritanceRelationshipsQueryIBTest(InheritanceRelationshipsQueryIBFixture fixture)
		: base(fixture)
	{ }
