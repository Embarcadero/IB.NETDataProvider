...
public class SqlQueryIBTest : SqlQueryTestBase<NorthwindQueryIBFixture<NoopModelCustomizer>>
{
	public SqlQueryIBTest(NorthwindQueryIBFixture<NoopModelCustomizer> fixture)
		: base(fixture)
	{ }
