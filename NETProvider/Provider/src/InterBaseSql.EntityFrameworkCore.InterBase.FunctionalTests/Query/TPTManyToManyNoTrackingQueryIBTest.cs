...
public class TPTManyToManyNoTrackingQueryIBTest : TPTManyToManyNoTrackingQueryRelationalTestBase<TPTManyToManyQueryIBFixture>
{
	public TPTManyToManyNoTrackingQueryIBTest(TPTManyToManyQueryIBFixture fixture)
		: base(fixture)
	{ }
