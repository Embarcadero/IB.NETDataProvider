...
public class NorthwindIncludeQueryIBTest : NorthwindIncludeQueryTestBase<NorthwindQueryIBFixture<NoopModelCustomizer>>
{
	public NorthwindIncludeQueryIBTest(NorthwindQueryIBFixture<NoopModelCustomizer> fixture)
		: base(fixture)
	{ }
