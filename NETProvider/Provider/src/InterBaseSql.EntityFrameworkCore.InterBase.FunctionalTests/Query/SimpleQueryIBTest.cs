...
{
	public class SimpleQueryIBTest : SimpleQueryTestBase<NorthwindQueryIBFixture<NoopModelCustomizer>>
	{
		public SimpleQueryIBTest(NorthwindQueryIBFixture<NoopModelCustomizer> fixture, ITestOutputHelper testOutputHelper)
			: base(fixture)
		{ }

		[Theory(Skip = "Different DECIMAL handling on InterBase.")]
