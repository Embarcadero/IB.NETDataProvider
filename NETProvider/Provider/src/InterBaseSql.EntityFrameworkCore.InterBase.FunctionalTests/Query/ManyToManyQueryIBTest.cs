...
public class ManyToManyQueryIBTest : ManyToManyQueryRelationalTestBase<ManyToManyQueryIBFixture>
{
	public ManyToManyQueryIBTest(ManyToManyQueryIBFixture fixture)
		: base(fixture)
	{ }
