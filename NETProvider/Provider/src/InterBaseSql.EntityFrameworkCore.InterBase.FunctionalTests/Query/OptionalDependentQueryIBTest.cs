...
public class OptionalDependentQueryIBTest : OptionalDependentQueryTestBase<OptionalDependentQueryIBFixture>
{
	public OptionalDependentQueryIBTest(OptionalDependentQueryIBFixture fixture)
		: base(fixture)
	{ }
