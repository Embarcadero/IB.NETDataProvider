...
{
	public class IncludeAsyncIBTest : IncludeAsyncTestBase<NorthwindQueryIBFixture<NoopModelCustomizer>>
	{
		public IncludeAsyncIBTest(NorthwindQueryIBFixture<NoopModelCustomizer> fixture)
			: base(fixture)
		{ }
