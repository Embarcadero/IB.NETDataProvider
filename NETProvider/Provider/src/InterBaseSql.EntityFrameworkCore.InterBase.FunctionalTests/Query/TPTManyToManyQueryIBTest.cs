...
public class TPTManyToManyQueryIBTest : TPTManyToManyQueryRelationalTestBase<TPTManyToManyQueryIBFixture>
{
	public TPTManyToManyQueryIBTest(TPTManyToManyQueryIBFixture fixture)
		: base(fixture)
	{ }
