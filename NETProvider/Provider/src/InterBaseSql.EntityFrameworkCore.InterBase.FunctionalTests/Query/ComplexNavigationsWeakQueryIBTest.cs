...
{
	public class ComplexNavigationsWeakQueryIBTest : ComplexNavigationsWeakQueryTestBase<ComplexNavigationsWeakQueryIBFixture>
	{
		public ComplexNavigationsWeakQueryIBTest(ComplexNavigationsWeakQueryIBFixture fixture, ITestOutputHelper testOutputHelper)
			: base(fixture)
		{ }
