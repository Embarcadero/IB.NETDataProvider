...
public class TPCManyToManyQueryIBTest : TPCManyToManyQueryRelationalTestBase<TPCManyToManyQueryIBFixture>
{
	public TPCManyToManyQueryIBTest(TPCManyToManyQueryIBFixture fixture)
		: base(fixture)
	{ }
