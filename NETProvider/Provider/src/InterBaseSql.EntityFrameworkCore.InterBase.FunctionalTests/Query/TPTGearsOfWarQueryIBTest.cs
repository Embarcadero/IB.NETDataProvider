...
public class TPTGearsOfWarQueryIBTest : TPTGearsOfWarQueryRelationalTestBase<TPTGearsOfWarQueryIBFixture>
{
	public TPTGearsOfWarQueryIBTest(TPTGearsOfWarQueryIBFixture fixture)
		: base(fixture)
	{ }
