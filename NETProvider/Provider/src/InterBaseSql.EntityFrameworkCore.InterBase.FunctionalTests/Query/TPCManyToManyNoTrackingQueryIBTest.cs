...
public class TPCManyToManyNoTrackingQueryIBTest : TPCManyToManyNoTrackingQueryRelationalTestBase<TPCManyToManyQueryIBFixture>
{
	public TPCManyToManyNoTrackingQueryIBTest(TPCManyToManyQueryIBFixture fixture)
		: base(fixture)
	{ }
