...
public class TPHInheritanceQueryIBFixture : TPHInheritanceQueryFixture
{
	...
	protected override void OnModelCreating(ModelBuilder modelBuilder, DbContext context)
	{
		...
		modelBuilder.Entity<Animal>().Property("Name").HasMaxLength(100);
		modelBuilder.Entity<AnimalQuery>().Property("Name").HasMaxLength(100);
		modelBuilder.Entity<Country>().Property("Name").HasMaxLength(100);
		modelBuilder.Entity<Plant>().Property("Name").HasMaxLength(100);
