...
public class NorthwindKeylessEntitiesQueryIBTest : NorthwindKeylessEntitiesQueryRelationalTestBase<NorthwindQueryIBFixture<NoopModelCustomizer>>
{
	public NorthwindKeylessEntitiesQueryIBTest(NorthwindQueryIBFixture<NoopModelCustomizer> fixture)
		: base(fixture)
	{ }
