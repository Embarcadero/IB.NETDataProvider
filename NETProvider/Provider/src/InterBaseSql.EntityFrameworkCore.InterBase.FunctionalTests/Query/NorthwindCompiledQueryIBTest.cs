...
public class NorthwindCompiledQueryIBTest : NorthwindCompiledQueryTestBase<NorthwindQueryIBFixture<NoopModelCustomizer>>
{
	public NorthwindCompiledQueryIBTest(NorthwindQueryIBFixture<NoopModelCustomizer> fixture)
		: base(fixture)
	{ }
