...
public class ComplexNavigationsCollectionsSplitQueryIBTest : ComplexNavigationsCollectionsSplitQueryRelationalTestBase<ComplexNavigationsQueryIBFixture>
{
	public ComplexNavigationsCollectionsSplitQueryIBTest(ComplexNavigationsQueryIBFixture fixture)
		: base(fixture)
	{ }
	...
	[NotSupportedRowsParameterCTEByInterBaseTheory]
	[MemberData(nameof(IsAsyncData))]
	public override Task Complex_multi_include_with_order_by_and_paging(bool async)
	{
		return base.Complex_multi_include_with_order_by_and_paging(async);
	}
}
