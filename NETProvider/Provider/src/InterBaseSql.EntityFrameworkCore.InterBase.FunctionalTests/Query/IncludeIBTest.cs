...
{
	public class IncludeIBTest : IncludeTestBase<NorthwindQueryIBFixture<NoopModelCustomizer>>
	{
		public IncludeIBTest(NorthwindQueryIBFixture<NoopModelCustomizer> fixture, ITestOutputHelper testOutputHelper)
			: base(fixture)
		{ }
