...
{
	public class IBProviderManifest : DbXmlEnabledProviderManifest
	{
		...
		public IBProviderManifest(string manifestToken)
			: base(IBProviderManifest.GetProviderManifest())
		{ }
		...
		{
			return "EntityFramework.InterBase.Resources.ProviderManifest.xml";
		}

		private static string GetStoreSchemaResourceName(string name, string type)
		{
			return string.Format("EntityFramework.InterBase.Resources.{0}.{1}", name, type);
		}
