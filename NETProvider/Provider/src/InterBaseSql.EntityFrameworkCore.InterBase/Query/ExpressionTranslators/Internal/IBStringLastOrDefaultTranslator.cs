...
public class IBStringLastOrDefaultTranslator : IMethodCallTranslator
{
	...
	public IBStringLastOrDefaultTranslator(IBSqlExpressionFactory ibSqlExpressionFactory)
	{
