...
public class IBSpacedFunctionExpression : SqlFunctionExpression, IEquatable<IBSpacedFunctionExpression>
{
	public IBSpacedFunctionExpression(string name, IEnumerable<SqlExpression> arguments, bool nullable, IEnumerable<bool> argumentsPropagateNullability, Type type, RelationalTypeMapping typeMapping)
	...
	protected override Expression VisitChildren(ExpressionVisitor visitor)
	{
		...
		return changed
			? new IBSpacedFunctionExpression(Name, arguments, IsNullable, ArgumentsPropagateNullability, Type, TypeMapping)
			: this;
	}
	...
	public override bool Equals(object obj)
	{
		return obj != null
			&& (ReferenceEquals(this, obj)
				|| obj is IBSpacedFunctionExpression ibExtraFunctionExpression
				&& Equals(ibExtraFunctionExpression));
	}

	public virtual bool Equals(IBSpacedFunctionExpression other)
	{
