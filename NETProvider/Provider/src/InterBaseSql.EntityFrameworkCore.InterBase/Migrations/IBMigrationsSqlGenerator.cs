...
using InterBaseSql.EntityFrameworkCore.InterBase.Migrations.Operations;
...
namespace InterBaseSql.EntityFrameworkCore.InterBase.Migrations
{
	public class IBMigrationsSqlGenerator : MigrationsSqlGenerator
	{
		...
		protected override void Generate(MigrationOperation operation, IModel model, MigrationCommandListBuilder builder)
		{
			switch (operation)
			{
				case IBCreateDatabaseOperation createDatabaseOperation:
					Generate(createDatabaseOperation, model, builder);
					break;
				case IBDropDatabaseOperation dropDatabaseOperation:
		...
		{
			builder.Append("alter generator ");
			builder.Append(Dependencies.SqlGenerationHelper.DelimitIdentifier(operation.Name, operation.Schema));
		...
		public virtual void Generate(IBCreateDatabaseOperation operation, IModel model, MigrationCommandListBuilder builder)
		{
			IBConnection.CreateDatabase(operation.ConnectionString);
		}

		public virtual void Generate(IBDropDatabaseOperation operation, IModel model, MigrationCommandListBuilder builder)
		{
			IBConnection.ClearPool(operation.ConnectionString);
			IBConnection.DropDatabase(operation.ConnectionString);
		}
