...
{
	public class IBProviderConfigurationCodeGenerator : ProviderCodeGenerator
	{
		public IBProviderConfigurationCodeGenerator(ProviderCodeGeneratorDependencies dependencies)
			: base(dependencies)
		{ }
