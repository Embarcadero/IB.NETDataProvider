...
public class IBSchemaTests : IBTestsBase
{
	#region Constructors

	public IBSchemaTests(IBServerType serverType)
		: base(serverType)
	{ }
	...
	public async Task TablesAsync()
	{
		...
		Assert.AreEqual(5, tables2.Rows.Count);
	}
...
public class IBSchemaTestsDialect1 : IBSchemaTests
{
	public IBSchemaTestsDialect1(IBServerType serverType)
		: base(serverType)
	{
