...
internal static class IscErrorMessages
{
	static Dictionary<int, string> _messages = new Dictionary<int, string>()
	{
		...
		{335544333, "internal InterBase consistency check ({0})"},		/* bug_check */
		...
		{335544472, "Your user name and password are not defined. Ask your database administrator to set up a InterBase login."},		/* login */
...
{2}"},		/* wal_bugcheck */
		...
		{335544521, "Unable to roll over please see InterBase log."},		/* wal_err_rollover2 */
		{335544522, "WAL I/O error.  Please see InterBase log."},		/* wal_err_logwrite */
		{335544523, "WAL writer - Journal server communication error.  Please see InterBase log."},		/* wal_err_jrn_comm */
		{335544524, "WAL buffers cannot be increased.  Please see InterBase log."},		/* wal_err_expansion */
		{335544525, "WAL setup error.  Please see InterBase log."},		/* wal_err_setup */
		...
		{335544547, "internal InterBase consistency check (invalid RDB$CONSTRAINT_TYPE)"},		/* invld_cnstrnt_type */
		...
		{335544689, "InterBase error"},		/* ib_error */
		...
		{335544745, "Your login {0} is same as one of the SQL role name. Ask your database administrator to set up a valid InterBase login."},		/* login_same_as_role_name */
		...
		{335544819, "File exceeded maximum size of 2GB.  Add another database file or use a 64 bit I/O version of InterBase."},		/* io_32bit_exceeded_err */
		...
		{335544917, "InterBase shutdown is still in progress after the specified timeout"},		/* shutdown_timeout */
...
Data source : {3}"},		/* eds_statement */
		...
		{335545106, "Error occurred during login, please check server InterBase.log for details"},		/* login_error */
		...
		{336003099, "INSERT field list does not match primary key of table {0}"},		/* upd_ins_doesnt_match_pk */
		{336003100, "INSERT field list does not match MATCHING clause"},		/* upd_ins_doesnt_match_matching */
		{336003101, "INSERT without MATCHING could not be used with views based on more than one table"},		/* upd_ins_with_complex_view */
		...
		{336397285, "create generator {0} failed"},		/* dsql_create_sequence_failed */
		...
		{336397304, "REcreate generator {0} failed"},		/* dsql_recreate_sequence_failed */
		...
		{336397323, "alter generator {0} failed"},		/* dsql_alter_sequence_failed */
		...
		{336986113, "Wrong value for access mode"},		/* ibsvcmgr_bad_am */
		{336986114, "Wrong value for write mode"},		/* ibsvcmgr_bad_wm */
		{336986115, "Wrong value for reserve space"},		/* ibsvcmgr_bad_rs */
		{336986116, "Unknown tag ({0}) in info_svr_db_info block after isc_svc_query()"},		/* ibsvcmgr_info_err */
		{336986117, "Unknown tag ({0}) in isc_svc_query() results"},		/* ibsvcmgr_query_err */
		{336986118, "Unknown switch \"{0}\""},		/* ibsvcmgr_switch_unknown */
		{336986159, "Wrong value for shutdown mode"},		/* ibsvcmgr_bad_sm */
		{336986160, "could not open file {0}"},		/* ibsvcmgr_fp_open */
		{336986161, "could not read file {0}"},		/* ibsvcmgr_fp_read */
		{336986162, "empty file {0}"},		/* ibsvcmgr_fp_empty */
		{336986164, "Invalid or missing parameter for switch {0}"},		/* ibsvcmgr_bad_arg */
