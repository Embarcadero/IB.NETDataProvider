...
internal abstract class StatementBase
{
	...
	public abstract void Execute(IDescriptorFiller descriptorFiller);
	public abstract ValueTask ExecuteAsync(IDescriptorFiller descriptorFiller, CancellationToken cancellationToken = default);
