...
{
	internal static class LinuxUnsafeNativeMethods
	{
		[DllImport("libdl.so")]
...
#pragma warning restore IDE1006 // Naming Styles
	...
	class LinuxClient : IIBClient
	{
		...
		protected IntPtr FIBLibrary;
		protected IntPtr FIBCrypt;
		...
		public virtual string Platform { get { return "Linux"; } }
		...
		protected virtual IntPtr GetProcAddress(string ProcName)
		{
			IntPtr Result = LinuxUnsafeNativeMethods.dlsym(FIBLibrary, ProcName);
		...
		protected virtual IntPtr LoadLibrary(string libName)
		{
			return LinuxUnsafeNativeMethods.dlopen(libName, LinuxUnsafeNativeMethods.RTLD_NOW);
		}
