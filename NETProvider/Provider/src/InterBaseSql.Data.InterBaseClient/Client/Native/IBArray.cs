...
namespace InterBaseSql.Data.Client.Native
{
	internal sealed class IBArray : ArrayBase
	{
		...
		public override byte[] GetSlice(int sliceLength)
		{
			...
			if (_db.IBClient.IBClientVersion >= 7)
			...
			if (_db.IBClient.IBClientVersion >= 7)
			{
				_db.IBClient.isc_array_get_slice2(
				_statusVector,
				ref dbHandle,
				ref trHandle,
				ref _handle,
			...
			{
				_db.IBClient.isc_array_get_slice(
				_statusVector,
				ref dbHandle,
				ref trHandle,
				ref _handle,
		...
		public override void PutSlice(Array sourceArray, int sliceLength)
		{
			...
			if (_db.IBClient.IBClientVersion >= 7)
			{
				_db.IBClient.isc_array_put_slice2(
				_statusVector,
				ref dbHandle,
				ref trHandle,
				ref _handle,
			...
			{ 
				_db.IBClient.isc_array_put_slice(
				_statusVector,
				ref dbHandle,
				ref trHandle,
				ref _handle,
